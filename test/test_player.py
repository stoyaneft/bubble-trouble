...
class PlayerTest(unittest.TestCase):
    ...
    def test_player_movement(self):
        ...
        self.player.update()
        self.assertEqual(startPlayerX + PLAYER_SPEED, self.player.rect.centerx, 'Player moving right is wrong')
        self.player.moving_right = False
        self.player.moving_left = True
        startPlayerX = self.player.rect.centerx
        self.player.update()
        self.assertEqual(startPlayerX - PLAYER_SPEED, self.player.rect.centerx, 'Player moving left is wrong')
